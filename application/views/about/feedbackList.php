						...
						<div class="box span10 oh">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr class="tr">
									...
									<td class="td_center"><a href="<?php echo site_url().'/about/feedback/editFeedback/'.$v['id'] ?>"><?php echo $v['title']?></a></td>
									<td class="td_center"><?php echo $v['email']?></td>
									<td class="td_center"><?php echo $v['mobile']?></td>			
									<td class="td_center"><?php echo date('m-d-y', $v['ctime'])?></td>
									
									<td class="td_center">
									【<a class="link-update" href="<?php echo site_url().'/about/feedback/editFeedback/'.$v['id'] ?>">修改</a>】
									&nbsp;&nbsp;&nbsp;&nbsp;
										【<a class="link-del" href="<?php echo site_url().'/about/feedback/delFeedback/'.$v['id'] ?>">删除</a>】
									</td>
								</tr>
								<?php endforeach; ?>
