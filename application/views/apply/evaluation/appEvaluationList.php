						...
						<div class="box span10 oh">
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr>
									...
									<th width="200">待评人邮箱</th>
									<th width="100">审核状态</th>
									<th width="100">审核人</th>									
									<th width="180">审核时间</th>
									<th>操作</th>
								</tr>
								<?php foreach ($evaluation as $v): ?>
								<tr class="tr">
									<td class="td_center"><input type="checkbox"></td>
									<td class="td_center"><a href="<?php echo site_url().'/apply/appEvaluation/editAppEvaluation/'.$v['id']?>">
									                      <?php echo $v['username']." 申请留学 ".$v['outcountry']?></a>
									</td>
									<td class="td_center"><a href="mailto:<?php echo $v['email']?>"><?php echo $v['email']?></a></td>
									<td class="td_center"><?php echo $v['status']?></td>
									<td class="td_center"><?php echo $v['author']?></td>									
									<td class="td_center"><?php echo $v['utime']?></td>
									<td class="td_center">
									<a class="link-update" 
									   href="<?php echo site_url().'/apply/appEvaluation/editAppEvaluation/'.$v['id'] ?>">审核</a>&nbsp;&nbsp;&nbsp;&nbsp;
									   <a class="link-del" href="<?php echo site_url().'/apply/appEvaluation/delAppEvaluation/'.$v['id']?>">删除</a></td>
								</tr>
								<?php endforeach; ?>
							</table>
